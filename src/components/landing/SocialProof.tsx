...
export default function SocialProof() {
  ...
  return (
    <section className="py-24 bg-zinc-50 dark:bg-zinc-900 relative overflow-x-clip">
      {/* Separator */}
      ...
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 p-6 sm:p-8 md:p-10 pt-10 sm:pt-8 rounded-2xl relative shadow-2xl dark:shadow-[0_0_50px_-20px_rgba(0,0,0,0.5)] mt-4 md:mt-0">
