...
// The router lives outside this component: main.tsx wraps App in BrowserRouter,
// scripts/prerender.mjs (via entry-server.tsx) wraps it in StaticRouter so every
