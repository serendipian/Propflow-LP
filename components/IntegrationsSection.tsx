...
const Logos: Record<string, React.ReactNode> = {
  ...
  Teams: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/63ed2cf2e410bc2aa208f7c0_logo-teams.svg" alt="Teams" className="w-full h-full object-contain" />
  ),
  Zoom: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/63ed2cf3c1f58b541e55cf73_logo-zoom.svg" alt="Zoom" className="w-full h-full object-contain" />
  ),
  GoogleMeet: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/662a79d4d28804818a2886f9_googlemeet.svg" alt="Meet" className="w-full h-full object-contain" />
  ),
  Slack: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/63ed27e9885e4172cd5eca5e_logo-slack.svg" alt="Slack" className="w-full h-full object-contain" />
  ),
  WhatsApp: (
  ...
  Gmail: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/63ed2cf20935cf1fef1d3b46_logo-gmail.svg" alt="Gmail" className="w-full h-full object-contain" />
  ),
  Calendar: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/63ed27e9ef91e965d9a0ba5e_logo-google-calendar.svg" alt="Calendar" className="w-full h-full object-contain" />
  ),
  OpenAI: (
    <img src="https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg" alt="OpenAI" className="w-full h-full object-contain dark:invert" />
  ),
  Notion: (
    <img src="https://cdn.prod.website-files.com/624c34ee1eb3ec0fbbc365fc/63ed27e9a693f25a793f0cc3_logo-notion.svg" alt="Notion" className="w-full h-full object-contain dark:invert" />
  ),
  Linear: (
  ...
  Facebook: (
    <svg viewBox="0 0 24 24" className="w-full h-full"><path fill="#1877F2" d="M24 12a12 12 0 1 0-13.88 11.85V15.47h-3.05V12h3.05V9.35c0-3 1.79-4.66 4.53-4.66 1.31 0 2.68.24 2.68.24v2.95h-1.5c-1.5 0-1.96.93-1.96 1.89V12h3.32l-.53 3.47h-2.79v8.38A12 12 0 0 0 24 12z"/></svg>
  ),
  LinkedIn: (
    <svg viewBox="0 0 24 24" className="w-full h-full"><path fill="#0077B5" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
  ),
  YouTube: (
    <svg viewBox="0 0 24 24" className="w-full h-full"><path fill="#FF0000" d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
  ),
  GoogleMaps: (
    <img src="https://upload.wikimedia.org/wikipedia/commons/a/aa/Google_Maps_icon_%282020%29.svg" alt="Google Maps" className="w-full h-full object-contain" />
  ),
};
